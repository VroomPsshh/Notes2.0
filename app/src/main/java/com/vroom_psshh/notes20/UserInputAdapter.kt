...
class UserInputAdapter(private val context: Context, private var entryList: List<UserInput>) :
    ...
    class ViewHolder(private var binding: NotesEntryListBinding) :
        ...
        fun bind(userInput: UserInput) {
            ...
            binding.notesCard.setOnLongClickListener {
                Toast.makeText(
                    context,
                    "hey this is your current position $adapterPosition",
                    Toast.LENGTH_SHORT
                ).show()
                dialog.show()
                true
